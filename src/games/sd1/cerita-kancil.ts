...
const TAMAN = story(
  ...
  ask(
    '🤔',
    'Tempat sampah ada di ujung taman. Apa yang sebaiknya Doni lakukan dengan gelas kosongnya?',
    'Membawanya ke tempat sampah di ujung taman',
    ['Meletakkannya saja di bawah bangku', 'Sampah yang ditinggalkan membuat taman kotor. Coba pilih yang lain!'],
...
const HUJAN = story(
  ...
  page('👧', 'Ayu membawa payung, jadi dia bersiap pulang.'),
  ask(
    '🧒',
    'Di teras sekolah, Beni berdiri sendirian. Dia lupa membawa payung. Apa yang sebaiknya Ayu lakukan?',
    'Mengajak Beni berteduh di bawah payungnya',
    ['Pulang cepat-cepat sendirian', 'Kalau ditinggal, Beni akan kehujanan. Coba pilih yang lain!'],
    ['Menertawakan Beni yang lupa membawa payung', 'Menertawakan teman membuatnya sedih. Ada cara yang lebih baik!'],
  ),
