...
- **Ilustrasi adegan utuh di halaman cerita (`kancil-rawa`)** (2026-08-10, gambar dari pemilik: *"Ganti kancil jalan di tepi rawa dengan ini"*), teruji headless 360×640, 380×800 & 820×1180 — cerita "Kancil dan Gajah" dimainkan sampai "Selamat!" (tiap pilihan yang kurang tepat ditekan lebih dulu), `kancil-rawa.webp` terambil 200, tanpa scroll & nol error console:
  - Halaman pembuka "Pagi itu Kancil berjalan di tepi rawa" dulu emoji 🦌; sekarang ilustrasi kiriman pemilik (kancil di jalan setapak, rawa berteratai, hutan bakau). Aset `public/assets/items/kancil-rawa.webp` — 900×491, 111 kB (kartu tampil maksimal 340 CSS px, jadi 900px sudah ±2,6× DPR; jangan diperbesar lagi).
  ...
  - **Halaman berilustrasi adegan SENGAJA tidak memakai `at()`.** Gambarnya sudah membawa hutan + air + tepiannya sendiri; latar gambar engine di belakangnya cuma jadi hutan di atas hutan. `at('sungai', …)` karena itu digeser ke halaman berikutnya (gajah terperosok) dan berlaku sampai cerita selesai — halaman tanpa `scene` mewarisi latar halaman SEBELUMNYA, jadi menggeser `at()` ke bawah aman, menghapusnya tidak.
